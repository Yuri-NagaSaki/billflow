          ...
          <CardContent className="flex flex-col flex-1">
            <div className="space-y-4 flex-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">ExchangeRate-API</p>
                </div>

                <div className="space-y-1">
                  <p className="text-sm font-medium">{t('apiConfiguration')}</p>
                  <div className="flex items-center gap-2">
                    {exchangeRateConfigStatus?.exchangeRateApiConfigured ? (
                      <>
            ...
            <div className="flex gap-2 mt-4">
              <Button
                ...
                disabled={isUpdating || !exchangeRateConfigStatus?.exchangeRateApiConfigured}
                size="sm"
              >
                {isUpdating ? (
